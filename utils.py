...
class DriverUtils:
    ...
    def get_mp_driver(cls):
        ...
        if cls.__mp_driver is None:
            ...
            cls.__mp_driver.get("http://ttmp.research.itcast.cn/")  # 测试网址
...
def check_channel_option(driver, channel_name, option_name):
    ...
    # 判断标识是否任为False,则抛出没找到对应的频道的选项
    if is_suc is False:
        NoSuchElementException("cann't find name is {} channel option".format(option_name))
